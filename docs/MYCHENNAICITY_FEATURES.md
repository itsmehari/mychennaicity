...
| **TN Plus Two education desk** | Wave A: `/guides/tn-plus-two`, `/groups/2502`–`2802`, compare, HSE structure, how-to-choose | Group selection (DGE codes). Textbooks + Tamil still planned. See [`.cursor/plans/tn-plus-two-education-desk.plan.md`](../.cursor/plans/tn-plus-two-education-desk.plan.md). |
| **TN Council of Ministers desk** | `/guides/tn-council-of-ministers`, `/ministers/[slug]`, departments, Chennai, IAS, official-sources; Tamil twin | 35 ministers (May 2026, Lok Bhavan PR 40). Filterable roster + department lookup. |
