    ...
    >
      ...
      >
        ...
        <div className="mt-6 space-y-3">
          <Link
            href="/contact"
            className="focus-ring flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-[color-mix(in_srgb,var(--accent)_28%,var(--border))] bg-[color-mix(in_srgb,var(--accent)_8%,var(--surface))] px-4 text-sm font-semibold text-[var(--accent)]"
            onClick={onClose}
          >
            <svg
              width="18"
