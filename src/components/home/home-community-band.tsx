  ...
  return (
    <>
        ...
        <div className="grid gap-6 rounded-[1.75rem] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm lg:grid-cols-[1fr_auto] lg:items-stretch">
          <div>
            ...
            <p className="type-lede mt-1 text-sm">
              Jobs, civic deadlines, and weekend events in one email. Tap
              Subscribe to join the list — or use WhatsApp for daily updates.
            </p>
          ...
          <div className="flex min-w-0 flex-col justify-center border-t border-[var(--border)] pt-6 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
            ...
            <p className="mt-4 text-xs leading-relaxed text-[var(--muted)]">
              Prefer chat? Join the official Chennai WhatsApp community linked
              above.
            </p>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-[1280px] px-4 pb-4 sm:px-6">
        <SiteUsageAudienceSection className="mt-4" />
      </div>
    </>
  );
}
